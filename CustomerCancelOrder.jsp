...
<div style="color: black; text-align: center; font-size: 30px;">Customer request for Cancel Order <i class="fas fa-times-circle"></i></div>
...
<hr>
       ...
       try
       {
    	   ...
    	   PreparedStatement ps=con.prepareStatement("select * from customercancel");
