...
<div style="color: black; text-align: center; font-size: 30px;">Cancel Orders <i class="fas fa-times-circle"></i></div>
...
<hr>
       ...
       try
       {
    	   ...
    	   PreparedStatement ps=con.prepareStatement("select * from myorder where status='cancel'");
